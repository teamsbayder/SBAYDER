...
if matches[2] == "تعطيل" and matches[2] == "البوت خدمي" then return lock_service(msg) end
if matches[2] == "تفعيل" and matches[2] == "البوت خدمي" then return unlock_service(msg) end
